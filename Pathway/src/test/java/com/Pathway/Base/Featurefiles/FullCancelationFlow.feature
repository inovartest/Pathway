...
Given enter url application into "chrome" for full cancelation flow with "local"
When first Market User login with valid creditinals for full cancelation process with "local"
Then Rise a full Cancelation Request with first Market User 2194
...
Then check the "Approved" status a Cancelation Request with first RPM User 2194
...
Then check the "Approved" status a Cancelation Request with first NOC User 2194
...
Then Request send to FCC of full cancelation process with  First Legal User 2194
...
Then Rise a Cancelation Request with second Market User 2195
...
Then check the "Rejected" status a Cancelation Request with second RPM User 2195
...
Then Rise a Cancelation Request with Third Market User 2196
...
Then check the "Approved" status a Cancelation Request with Third RPM User 2196
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 2196
...
Then Rise a Cancelation Request with fourth Market User 2197
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 2197
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 2197
...
Then Rise a full Cancelation Request with  fifth RPM User 2198
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 2198
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 2198
...
Then Rise a full Cancelation Request with  sixth RPM User 2199
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 2199
...
Then Rise a full Cancelation Request with  Seventh RPM User 2616
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 2616
