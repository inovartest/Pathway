...
Then Rise a Partial Cancelation Request with first Market User 2349
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 2349
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 2349
...
Then Request send to FCC of Partial cancelation process with  First Legal User 2349
...
Then Rise a Partial Cancelation Request with second Market User 2350
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 2350
...
Then Rise a Partial Cancelation Request with Third Market User 2351
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 2351
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 2351
...
Then Rise a Partial Cancelation Request with fourth Market User 2352
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 2352
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 2352
...
Then Rise a Partial Cancelation Request with  fifth RPM User 2353
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 2353
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 2353
...
Then Rise a Partial Cancelation Request with  sixth RPM User 2354
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 2354
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 2355
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 2355
