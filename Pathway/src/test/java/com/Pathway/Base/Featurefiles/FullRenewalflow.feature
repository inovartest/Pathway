...
When first RPM User login with valid creditinals for Renewal process with "local"
Then Rise a Renewal Request with  first RPM User 2240
...
Then check the "Approved" status a Renewal Request with  first NOC User 2241
...
Then Request send to FCC of Renewal Request with  first Legal User 2241
...
Then Rise a Renewal Request with  second RPM User 2242
...
Then check the "Rejected" status a Renewal Request with  second NOC User 2242
...
Then Rise a Renewal Request with  third RPM User 2243
...
Then check the "Approved" status a Renewal Request with  third NOC User 2243
