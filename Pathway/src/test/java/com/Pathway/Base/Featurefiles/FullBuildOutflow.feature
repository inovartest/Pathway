...
Then Rise a BuildOutflow Request with  sixth RPM User 2614 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 2614
...
Then Rise a BuildOutflow Request with  Seventh RPM User 2615 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 2615
